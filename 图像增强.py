...
if __name__ == '__main__':
    masksjson_dir = r'D:\508\STS2024\NewDataset\LabeledTrain\f\MasksJson'
    maskspic_dir = r'D:\508\STS2024\NewDataset\LabeledTrain\f\MasksPic'
    for masksjson in os.listdir(masksjson_dir):
        maskjson_path = os.path.join(masksjson_dir, masksjson)
        visualize_json(maskjson_path, maskspic_dir)
    print('Done')
